...
class Cifar100:
    ...
    def initialize(self):
        ...
        train_groups = [[] for g in range(self.batch_num)]
        base_cls = 100 // self.batch_num
        for train_data, train_label in zip(self.train_data, self.train_labels):
            ...
            train_groups[train_label//base_cls].append((train_data,train_label))
...
#                 train_groups[4].append((train_data,train_label))
        ...
        test_groups = [[] for g in range(self.batch_num)]
        for test_data, test_label in zip(self.test_data, self.test_labels):
            ...
            test_groups[test_label//base_cls].append((test_data,test_label))
#             if test_label < 20:
...
#                 test_groups[4].append((test_data,test_label))
        ...
        val_groups = [[] for g in range(self.batch_num)]
